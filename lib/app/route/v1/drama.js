...
drama.get('/dramas/like', userCtrl.requireUser, userCtrl.getLikedDrama);
...
drama.post('/dramas/like', userCtrl.requireAuth, userCtrl.addLikedDrama);
...
drama.delete('/dramas/like/:did', userCtrl.requireAuth, userCtrl.removeLikedDrama);
